...
% 创建窗口
Fig =figure("name","Drones Trajectory Elevator", "position", [100 100 1200 750]);
%增加暂停按钮
                                ...
                                if drone(x,11,z)==1
                                    ...
                                    if drone(x,9,z)>0%处于drone拍摄时间
                                        ...
                                        if drone(x,9,z)<=0 %drone拍摄时间结束
                                            ...
                                            if drone(x,1,z)==drone(x-1,1,z) %判断是否遭遇异环
                                                if drone(x,8,z)>0 %判断是否有携带包
