...
W=inputdlg({'待扫描区域半径','无人机有效扫描半径','无人机有效通讯半径','设置扫描扇区数','时间度量','最外环飞行速度m/s','目标节点个数','角速度刻度','无人机能量','信息收集轮次'},'输入参数集',1,{'1000','150','300','6','0.001','30','50','8000','100000','30'});
